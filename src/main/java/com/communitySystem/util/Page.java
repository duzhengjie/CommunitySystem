...
public class Page<T> {
	...
	public Page(int pageSize) {
		...
		actionUrl = CommonBaseAction.getRequest().getServletPath();
		System.out.println("pageURL:" + actionUrl);
	}
	...
	public String toString() {
		...
		builder.append("Page [pageNo=").append(pageNo).append(", pageSize=").append(pageSize).append(", list=")
				.append(list).append(", totalPage=").append(totalPage).append(", totalRecord=").append(totalRecord)
				.append("]");
